...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-jetblack"
    >
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-jetblack via-darkslategrey/60 to-jetblack/90 z-10" />
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2">
        <p className="text-tan text-xs font-body">Scroll ke bawah</p>
